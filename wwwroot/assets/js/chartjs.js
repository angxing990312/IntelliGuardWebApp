$(function () {
    ...
    if ($('#chartjsBar').length) {
        new Chart($("#chartjsBar"), {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: "Number of students passed at this timing",
    ...
    if ($('#chartjsDoughnut').length) {
        new Chart($('#chartjsDoughnut'), {
            type: 'doughnut',
            data: {
                labels: ["less than 37.5 degrees", "equal or more than 37.5 degrees"],
                datasets: [
                    {
                        label: "Students having fever vs. Students with normal tempereature",
